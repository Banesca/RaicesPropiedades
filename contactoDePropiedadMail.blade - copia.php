                                  ...
                                  @if($r==0)
                                        ...
                                        <td width="40%" align="left"
                                            ...
                                            <img class="img-fluid mt-3"
                                                ...
                                                src="{{asset('img/raices/Recurso 22.svg')}}" />
                                            <p>
                                                <strong>
                                                    @switch($key)
                                                    ...
                                                    @break
                                                    @case('Ambientes_CuartoDeHerramientas') Cuarto De Herramientas
                                                    @break
                                                    ...
                                                    @break
                                                    @case('Ambientes_DependenciaDeServicio') Dependencia De Servicio
                                                    @break
                                                    ...
                                                    @break
                                                    @case('piso_Radiante_Individual') Piso Radiante Individual
                                                    @break
                                        ...
                                        <td width="40%" align="left"
                                            ...
                                            <p>
                                                <strong>
                                                    ...
                                                    @break
                                                    @case('Instalaciones_AireAcondicionadoCentral') Aire Acondicionado
                                                    Central
                                                    @break
                                                    ...
                                                    @break
                                                    @case('Instalaciones_ArtefactosDeCocina') Artefactos De Cocina
                                                    @break
                                                    ...
                                                    @break
                                                    @case('Instalaciones_EspacioParaVehiculo') Espacio Para Vehículo
                                                    @break
                                        ...
                                        <td width="40%" align="left"
                                            ...
                                            <p>
                                                <strong>
                                                    ...
                                                    @break
                                                    @case('CantidadPersonal') Cantidad de Oficinas:
                                                    @break
                                                    @case('CantidadPisos') Cantidad de Oficinas:
                                                    @break
                                                    ...
                                                    @break
                                                    @case('Direccion_Coordenadas_Latitud') Coordenadas Latitud:
                                                    @break
                                                    @case('Direccion_Coordenadas_Longitud') Coordenadas Longitud:
                                                    @break
