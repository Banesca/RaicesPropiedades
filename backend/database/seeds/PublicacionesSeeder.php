    ...
    public function run() {
        ...
        for ($i = 0; $i < 20; $i++) {
            ...
            $ficha3 = new Propiedad([
                ...
                'Estado'                                    => rand(0, 1),
                'Expensas'                                  => rand(0, 1),
                'fk_Direccion_Barrio_Id'                    => rand(91, 200),
                'fk_Direccion_Calle_Id'                     => rand(1, 3),
                'fk_Direccion_Ciudad_Id'                    => rand(1, 3),
                'fk_Direccion_Localidad_Id'                 => rand(3, 412),
                'fk_Direccion_Pais_Id'                      => 1,
                'fk_Direccion_Partido_Id'                   => rand(1, 499),
                'fk_Direccion_Provincia_Id'                 => rand(1, 71),
                'fk_Direccion_SubBarrio_Id'                 => rand(1, 43),
                'fk_Direccion_Region_Id'                    => rand(1, 43),
                ...
                'fk_TipoUnidadCasa'                         => rand(1, 3),
                'fk_TipoUnidadDepartamento'                 => rand(1, 3),
                ...
                'Edificio_Servicios_ABL'           => rand(0, 1),
                'Edificio_Servicios_AguaCorriente' => rand(0, 1),
                'Edificio_Servicios_Bar'           => rand(0, 1),
                'Edificio_Servicios_Calefaccion'   => rand(0, 1),
                'Edificio_Servicios_Cocina'        => rand(0, 1),
                'Edificio_Servicios_Conmutador'    => rand(0, 1),
                'Edificio_Servicios_Electricidad'  => rand(0, 1),
                'Edificio_Servicios_GasEnvasado'   => rand(0, 1),
                'Edificio_Servicios_GasNatural'    => rand(0, 1),
                'Edificio_Servicios_Internet'      => rand(0, 1),
                'Edificio_Servicios_Lavanderia'    => rand(0, 1),
                'Edificio_Servicios_Refrigeracion' => rand(0, 1),
                'Edificio_Servicios_Rentas'        => rand(0, 1),
                'Edificio_Servicios_Seguridad'     => rand(0, 1),
                'Edificio_Servicios_Telefono'      => rand(0, 1),
