...
class CreateDepartamentosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tb_departamentos', function (Blueprint $table) {
            ...
            $table->integer('fk_Edificio_TipoEdificio')->nullable();
            ...
            $table->integer('fk_Edificio_TipoFrente')->nullable();
            $table->integer('fk_Edificio_TipoVista')->nullable();
            $table->integer('fk_Edificio_TipoCosta')->nullable();
