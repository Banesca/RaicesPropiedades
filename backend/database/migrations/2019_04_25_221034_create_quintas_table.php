...
class CreateQuintasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tb_quintas', function (Blueprint $table) {
            ...
            $table->integer('Casa_fk_Estado')->nullable();
            $table->integer('Casa_fk_TipoUnidad')->nullable();
            $table->integer('Casa_fk_TipoTecho')->nullable();
            $table->integer('Casa_fk_TipoPiso')->nullable();
            ...
            $table->integer('Casa_fk_Orientacion')->nullable();
            $table->integer('Casa_fk_TipoCosta')->nullable();
            $table->integer('Casa_fk_TipoVista')->nullable();
            $table->integer('Casa_fk_TipoPendiente')->nullable();
