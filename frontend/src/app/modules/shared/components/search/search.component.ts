...
export class SearchComponent implements OnInit {
    ...
    emptyValues() {
        ...
        this.selectedCalle = {id: null, nombre: "Calle"};
    ...
    setProvince = (value: any): void => {
        ...
        this.articuloService
            ...
            .then(response => {
                ...
                this.selectedPartido.nombre = "Partidos";
    ...
    setPartido = (value: any): void => {
        ...
        this.articuloService
            ...
            .then(response => {
                this.selectedLocalidad.nombre = "Localidades";
    ...
    setLocalidad = (value: any): void => {
        ...
        this.articuloService
            ...
            .then(response => {
                this.selectedBarrio.nombre = "Barrios";
        ...
        this.articuloService
            .getCalle({idLocalidad: value.id})
            .then(response => {
                this.selectedCalle.nombre = "Calles";
    ...
    searchFilter() {
        if ((this.selectedMinimo == null && this.selectedMaximo != null) || (this.selectedMaximo == null && this.selectedMinimo != null)) {
