...
export class UsuariosComponent implements OnInit {
   ...
   actualizar() {
      ...
      this.mLoading = true;
      console.log(this.id)
      if ((this.mCategoriasSelect.password || this.mCategoriasSelect.password_confirmation) && (this.mCategoriasSelect.password !== this.mCategoriasSelect.password_confirmation)) {
   ...
   rulesPassword() {
      ...
      if (this.mCategoriasSelect.id) {
         if (!this.mForma.get('password').value || !this.mForma.get('password_confirmation').value) {
