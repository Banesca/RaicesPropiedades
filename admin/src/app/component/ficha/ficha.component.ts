...
export class FichaComponent implements OnInit {
  ...
  update(ficha) {
    this.fichasSelect = ficha;
    this.idficha = ficha.idFichas;
    this.formEstado = enCRUD.Actualizar;
    console.log(ficha.imagenes.img1fa);
    this.form.controls["img1fa"].setValue(ficha.imagenes.img1fa);
    this.form.controls["img2pr"].setValue(ficha.imagenes.img2pr);
    this.form.controls["img3pl"].setValue(ficha.imagenes.img3pl);
    this.form.controls["img4pl"].setValue(ficha.imagenes.img4pl);
    this.form.controls["img5sa"].setValue(ficha.imagenes.img5sa);
    this.form.controls["img6sa"].setValue(ficha.imagenes.img6sa);
    this.form.controls["titulo"].setValue(ficha.titulo);
    this.form.controls["valor"].setValue(ficha.valor);
    this.form.controls["caracteristica"].setValue(ficha.caracteristica);
    this.form.controls["comision"].setValue(ficha.comision);
    this.form.controls["ubicacion"].setValue(ficha.ubicacion);
  }
  ...
  actualizar() {
    ...
    this._FichaService
      .actualizarFicha(formData, this.idficha)
      .then((resp: any) => {
        this.formEstado = enCRUD.Eliminar;
        this.getAll();
        this.mLoading = false;
    ...
    if (evt.target.files && evt.target.files.length) {
      ...
      if (fileTo.size > 5000000) {
        this._AlertsService.msg(
          "ERR",
          "Error:",
          "El archivo es muy pesado, peso máximo 5Mb"
        );
        return;
      }
      ...
      switch (section) {
        case "img1fa":
          ...
          reader.onload = (event) => {
            this.form.controls["img1fa"].setValue(
        ...
        case "img2pr":
          ...
          //Asignamos el fakeUrl
          reader.onload = (event) => {
            this.form.controls["img2pr"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
        case "img3pl":
          ...
          //Asignamos el fakeUrl
          reader.onload = (event) => {
            this.form.controls["img3pl"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
        case "img4pl":
          ...
          //Asignamos el fakeUrl
          reader.onload = (event) => {
            this.form.controls["img4pl"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
        case "img5sa":
          ...
          //Asignamos el fakeUrl
          reader.onload = (event) => {
            this.form.controls["img5sa"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
        case "img6sa":
          ...
          //Asignamos el fakeUrl
          reader.onload = (event) => {
            this.form.controls["img6sa"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
