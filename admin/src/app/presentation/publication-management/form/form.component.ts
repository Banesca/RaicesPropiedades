      ...
      this.service.getPropiedad(this.id).then((res: any) => {
        ...
        this.formThree.setValue({
          ...
          no_publicar_precio_inter:
            res.no_publicar_precio_inter == 1 ? true : false,
          ...
          Generales_PermiteMascotas:
            res.Generales_PermiteMascotas == "1" ? true : false,
          Generales_SeguroCaucion:
            res.Generales_SeguroCaucion == "1" ? true : false,
          ...
          LateralDerechoIrregular:
            res.LateralDerechoIrregular == "1" ? true : false,
          LateralIzquierdoIrregular:
            res.LateralIzquierdoIrregular == "1" ? true : false,
