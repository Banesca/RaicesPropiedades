...
export class FormComponent implements OnInit {
  ...
  createForm(isUpdate?: boolean) {
    ...
    this.formThree = this.fb.group({
      ...
      Direccion_Numero: ['', Validators.pattern("^[0-9]+$")],
      Direccion_Piso: [''],
      ...
      //Caracteristicas
      //Inputs
      LongitudFrente: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      LongitudFondo: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      Antiguedad: ["", Validators.pattern("^[0-9]+$")],
      SuperficieCubierta: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      SuperficieDescubierta: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      ...
      SuperficieTerreno: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      Largo: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      Ancho: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      Altura: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      MontoExpensas: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      MetrosDeLaEsquina: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      UltimaActividad: [""],
      GaleriaShopping: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      SuperficiePlaya: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      SuperficieDeposito: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      CantidadPisos: ["", Validators.pattern("^[0-9]+$")],
      HabitacionesPorPiso: ["", Validators.pattern("^[0-9]+$")],
      CantidadPersonal: ["", Validators.pattern("^[0-9]+$")],
      RentabilidadAnual: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      CantidadHabitaciones: ["", Validators.pattern("^[0-9]+$")],
      CantidadEstrellas: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      CantidadPlazas: ["", Validators.pattern("^[0-9]+$")],
      CantidadCubiertos: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      SuperficieTotal: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      SuperficieConstruible: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      MedidaLinealDerecha: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      MedidaLinealIzquierda: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      FOT: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      Zonificacion: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      SuperficiePlanta: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      DepartamentosPorPiso: ["", Validators.pattern("^[0-9]+$")],
      SuperficieOficina: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      SuperficieCubiertaCasa: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      CantidadHectareas: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      DistanciaPavimento: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      SuperficieLocal: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      ReferenciaCercana: [""],
      AntiguedadComercio: ["", Validators.pattern("^[0-9]+$")],
      RecaudacionMensual: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      CantidadOficinas: ["", Validators.pattern("^[0-9]+$")],
      AnchoEntrada: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      AltoEntrada: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      CantidadColumnas: ["", Validators.pattern("^[0-9]+$")],
      CantidadNaves: ["", Validators.pattern("^[0-9]+$")],
      AlturaTecho: ["", Validators.pattern("^-?[0-9]\\d*(\\.\\d{1,2})?$")],
      Detalle: [""],
      TipoBien: [""],
    ...
    if (isUpdate) {
      ...
      this.service.getPropiedad(this.id).then((res: any) => {
        ...
        this.formTwo.setValue({
          ...
          image10: res.imagen10 ? res.imagenes.imagen10 : null,
          image11: res.imagen11 ? res.imagenes.imagen11 : null,
          image12: res.imagen12 ? res.imagenes.imagen12 : null,
  ...
  getDataForm() {
    ...
    this.image10 ? (obj.imagen10 = this.image10) : null;
    this.image11 ? (obj.imagen11 = this.image11) : null;
    this.image12 ? (obj.imagen12 = this.image12) : null;
    ...
    obj.informacion_adicional = data3.informacion_adicional;
    ...
    if (event.target.files && event.target.files.length) {
      ...
      switch (section) {
        ...
        case "image10":
          this.image10 = fileTo;
          reader.onload = (event) => {
            this.formTwo.controls["image10"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
        ...
        case "image11":
          this.image11 = fileTo;
          reader.onload = (event) => {
            this.formTwo.controls["image11"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
        ...
        case "image12":
          this.image12 = fileTo;
          reader.onload = (event) => {
            this.formTwo.controls["image12"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
        ...
        case "image13":
          this.image13 = fileTo;
          reader.onload = (event) => {
            this.formTwo.controls["image13"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
        ...
        case "image14":
          this.image14 = fileTo;
          reader.onload = (event) => {
            this.formTwo.controls["image14"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
          ...
          this.image15 = fileTo;
          reader.onload = (event) => {
            this.formTwo.controls["image15"].setValue(
              (<FileReader>event.target).result
            );
          };
          break;
